...
const Projects = () => {
  return (
    <div>
      ...
      >
        <div className="flex flex-row text-blue-200 mt-4 items-center gap-2">
          <h1 className="text-[30px] text-yellow-500 font-bold md:text-[40px] lg:text-[35px]">
            Projects
          </h1>
          <div className="border-b-4 border-solid border-blue-100 p-1 w-16 border-yellow-500"></div>
        </div>
